...
namespace Anu.Jobs
{
    ...
    {
        public async Task<JobState> ExecuteJob(IJob job, JobState state, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                state.RecordStageTransition(JobStage.Executing);
        ...
        public async Task<JobState> ExecuteCompensation(IJob job, JobState state, CancellationToken cancellationToken = default)
        {
            try
            {
                // Create job context from state
